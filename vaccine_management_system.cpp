...
void vaccine::search_by_age()
{
   ifstream in("vaccinetrial.txt");
    ...
    cout<<"\n\n\n\n Number of people vaccinated at this age"<<p;
    in.close();
...
void vaccine::search_by_profession()
{
    ...
    if(flag==0)
    {
    cout<<"The profession you have entered does not exist"<<endl;
    }
    cout<<"\n\n\n Number of people vaccinated in this profession "<<p<<endl;
    in.close();
}
void vaccine::search_by_gender()
{
    ...
    cout<<"\n\n\n Number of people vaccinated that belong to this gender "<<p<<endl;
    in.close();
}
...
void menu()
{
    ...
    cout<<"\n\t\t3: Search   \t\t\t\t 4: display all records \t\t\t\t 5.exit" <<endl;
}
int main()
 {
     vaccine obj;
